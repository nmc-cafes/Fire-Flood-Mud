...
site_selection <- ggplot() +
  ...
  geom_spatvector(data = drain_buff_mask, color = "skyblue", linetype = "dashed", linewidth = 0.7, fill = "skyblue") +
  geom_spatvector(data = drain_buff_inverse, color = "skyblue", linetype = "dashed", linewidth = 0.7, fill = NA) +
