...
knp_sev <- read_SBS(here("Fire_Data","KNP","KNP_SBS.tif"))
caldor_sev <- read_SBS(here("Fire_Data","Caldor","Caldor_SBS.tif"))
dixie_sev <- read_SBS(here("Fire_Data","Dixie","Dixie_SBS.tif"))
cedar_sev <- read_SBS(here("Fire_Data","CedarCreek","CedarCreek_SBS.tif"))
cub_sev <- read_SBS(here("Fire_Data","CubCreek2","CubCreek2_SBS.tif"))

knp_ig <- read_ig(here("Fire_Data","KNP","Fire_Progression","KNP_COMPLEX_2021_PROGRESSION_CORRECTED.shp"))
caldor_ig <- read_ig(here("Fire_Data","Caldor","Fire_Progression","CALDOR_2021_PROGRESSION_CORRECTED.shp"))
dixie_ig <- read_ig(here("Fire_Data","Dixie","Fire_Progression","DIXIE_2021_PROGRESSION_CORRECTED.shp"), dixie=T)
cedar_ig <- read_ig(here("Fire_Data","CedarCreek","Fire_Progression","CEDAR_CREEK_2021_PROGRESSION_CORRECTED.shp"))
cub_ig <- read_ig(here("Fire_Data","CubCreek2","Fire_Progression","CUB_CREEK_2_2021_PROGRESSION_CORRECTED.shp"))
